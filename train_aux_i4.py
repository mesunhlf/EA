...
INCEPTION_CHECKPOINT_PATH = '/home/zhuangwz/dataset/ckpt_models/inception_v4.ckpt'
input_path = '/home/zhuangwz/dataset/ILSVRC2012/val'
output_path = '/home/zhuangwz/code/sa_result/erosion_model/'
batch_size = 16
epoch_num = 10
model = 'Aux_InceptionV4'
output_path = os.path.join(output_path, model)
out_layer = ['Mixed_6g']
# out_layer = ['Mixed_6a', 'Mixed_6c', 'Mixed_6e', 'Mixed_6g', 'Mixed_7a', 'Mixed_7c', 'Mixed_7d']
...
logits, endpoints = inceptionv4_model(x)
print(endpoints)
...
er_logits, er_endpoints = inceptionv4_model(x, noise=0.1, var=kernel_3)
