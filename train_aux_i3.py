...
#
INCEPTION_CHECKPOINT_PATH = '/home/zhuangwz/dataset/ckpt_models/inception_v3.ckpt'
input_path = '/home/zhuangwz/dataset/ILSVRC2012/val'
output_path = '/home/zhuangwz/code/sa_result/train_model/'
batch_size = 16
epoch_num = 10
model = 'Aux_InceptionV3'
output_path = os.path.join(output_path, model)
out_layer = ['Mixed_6e']
# out_layer = ['Mixed_6a', 'Mixed_6b','Mixed_6c','Mixed_6d', 'Mixed_6e', 'Mixed_7a', 'Mixed_7b']
...
logits, endpoints = inceptionv3_model(x)
...
# er_logits, er_endpoints = inceptionv3_model(x, noise=0.1, var=kernel_3)
er_logits, er_endpoints = inceptionv3_model(x)
